...
<dsp:page>
    ...
    <dsp:include page="../common/HeadBody.jsp" flush="false"><dsp:param name="pagetitle"
                                                                        value=" Saved Orders"/></dsp:include>
        ...
        <tr valign=top>
            ...
            <td valign="top" width=745>
                ...
                <table border=0 cellpadding=4 width=80%>
                    <tr>
                        <td><img src="../images/d.gif" vspace=0></td>
                    </tr>
                    <tr valign=top>
                    ...
                    <tr>
                        <td colspan=2>
                            <table width=100% cellpadding=3 cellspacing=0 border=0>
                                <tr>
                                    <td class=box-top>&nbsp;Saved Orders</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
                                        ...
                                        <dsp:droplet name="ForEach">
                                            ...
                                            <dsp:oparam name="output">
                                                <tr>
                                                    ...
                                                    <td></td>
                                                    <td><dsp:valueof date="MMMM d, yyyy h:mm a"
                                                                     param="element.creationDate"/></td>
                                                </tr>
                                            </dsp:oparam>
                                        </dsp:droplet>
                                    </table>
