...
seeing other people's orders. We might use the obfuscated id generator, but this is safter then even that*/%>
    ...
    <dsp:include page="../common/HeadBody.jsp" flush="false"><dsp:param name="pagetitle"
                                                                        value=" Saved Order"/></dsp:include>

    <table border=0 cellpadding=0 cellspacing=0 width=800>
        <tr>
            <td colspan=2><dsp:include page="../common/BrandNav.jsp" flush="false"></dsp:include></td>
        </tr>
        <tr bgcolor="#DBDBDB">
                    ...
                    <tr>
                        <td colspan=2>
                            <table width=100% cellpadding=3 cellspacing=0 border=0>
                                <tr>
                                    <td class=box-top>&nbsp;Saved Order</td>
                                </tr>
                            </table>
                        </td>
                    </tr>
         ...
         - Saved <dsp:valueof date="MMMMM d, yyyy h:mm a" param="order.creationDate"/></span>
                                    ...
                                    <table border=0 cellpadding=4 cellspacing=1>
                                        ...
                                        <dsp:droplet name="ForEach">
                                            ...
                                            <dsp:oparam name="output">
                                                <dsp:getvalueof id="currentItem" param="element"
                                        ...
                                        <tr>
                                            ...
                                            <td></td>
                                            <td align="right">
                                                <b><dsp:valueof converter="currency" locale="Profile.priceList.locale"
                                                                param="order.priceInfo.amount"/></b>
                                            </td>
                                        </tr>
                                            ...
                                            <td colspan=4 align=right>
                                                <dsp:form formid="use" action="../checkout/cart.jsp" method="post">
                                                    <dsp:input bean="ShoppingCart.handlerOrderId" paramvalue="order.id"
                                                               type="hidden"/>
                                                    <dsp:input bean="ShoppingCart.switch" type="submit"
                                                               value="Make this your current order"/> &nbsp;
                                                </dsp:form>
                                            </td>
                                            <td colspan=2 align=left>
                                                <dsp:form formid="delete" action="../user/saved_orders.jsp"
                                                          method="post">
                                                    <dsp:input bean="ShoppingCart.handlerOrderId" paramvalue="order.id"
                                                               type="hidden"/>
...
<%-- @version $Id: //edu/ILT-Courses/main/Commerce/StudentFiles/Commerce/setup/DynamusicB2C/j2ee-apps/dynamusicb2c-j2ee/dynamusicb2c.war/saved_order.jsp#9 $$Change: 514668 $--%>
