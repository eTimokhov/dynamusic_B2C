    ...
    <table width="700" cellpadding="8">
        <tr>
            ...
            <td>
                <table width="700" cellpadding="8">
                    <tr>
                        <td width="75" valign="center"><font face="Verdana,Geneva,Arial" color="midnightblue"><span
                                class="big">Current Order</span></td>
                    </tr>
                    ...
                    <tr>
                        <td colspan=2>
                            <table width=100% cellpadding=3 cellspacing=0 border=0>
                                <tr>
                                    <td class=box-top>&nbsp;Save Current Order</td>
                                </tr>
                                <tr>
                                    <td><b>Order # <dsp:valueof bean="ShoppingCart.current.id"/></b>
                                        ...
                                        Enter a name to identify this order:<p>
                                                ...
                                                <dsp:input bean="SaveOrderFormHandler.saveOrder" type="submit"
                                                           value="Save order"/>
                                                <dsp:input bean="SaveOrderFormHandler.saveOrder" type="hidden"
                                                           value="save"/>
                                    ...
                                    <td>
                                        <table cellspacing=0 cellpadding=0 border=0 width=100%>
                                            <tr valign=top>
                                                <td>
                                                    <table cellspacing=2 cellpadding=0 border=0>
                                                        ...
                                                        <tr>
                                                            <td><<dsp:valueof param="CIRelationship.quantity"/>'
                                                                size="2">&nbsp;
                                                            </td>
                                                            <td><dsp:valueof
                                            ...
                                            <tr>
                                                ...
                                                <td></td>
                                                <td align="right">
                                                    <b><dsp:valueof bean="ShoppingCart.current.priceInfo.amount"
                                                                    converter="currency"
                                                                    locale="Profile.priceList.locale"/></b>
                                                </td>
                                            </tr>
                                        </table>
                                        </dsp:form>
