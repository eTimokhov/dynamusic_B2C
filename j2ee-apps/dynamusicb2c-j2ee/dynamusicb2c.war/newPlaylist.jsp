        ...
        <tr>
            ...
            <td VALIGN=TOP>
                ...
                <dsp:form action="newPlaylist.jsp" method="post">
                    ...
                    Playlist name:<br>
                    <dsp:input bean="PlaylistFormHandler.value.name" name="name" size="24" type="text"
                               required="<%=true%>"/><br>

                    Description:<br>
                    <dsp:textarea bean="PlaylistFormHandler.value.description" name="description" rows="5"
                                  cols="40"/><br>
