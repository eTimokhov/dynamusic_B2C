        ...
        <tr>
            ...
            <td width="100" bgcolor="ghostwhite" valign="top">
                ...
                <dsp:droplet name="/atg/userdirectory/droplet/HasFunction">
                    ...
                    <dsp:param bean="/atg/userprofiling/Profile.id" name="userId"/>
                    <dsp:oparam name="true">
                        <br><font face="Verdana,Geneva,Arial" size="-1" color="steelblue">
                        <b><dsp:a href="newVenue.jsp">Add New Venue</dsp:a> </b></font>
                    </dsp:oparam>
                </dsp:droplet>
            </td>
            <!-- Page Body -->
