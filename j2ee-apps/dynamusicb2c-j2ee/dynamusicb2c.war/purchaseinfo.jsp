                ...
                <font face="Verdana,Geneva,Arial" color="midnightblue">
                    ...
                    <dsp:form action="purchaseinfo.jsp" method="post">
                        ...
                        <p>
                            ...
                            <b>First Name:</b> <dsp:input
                                bean="ExpressCheckoutFormHandler.paymentGroup.billingAddress.firstName"
                        ...
                        <p>
                            <font face="Verdana,Geneva,Arial" size="+2" color="midnightblue">Credit Card
                                Type:</font><br>
                            <dsp:select bean="ExpressCheckoutFormHandler.paymentGroup.creditCardType"
                                        required="<%=true%>">
                                <dsp:option value="Visa"/>Visa
                                <dsp:option value="MasterCard"/>Master Card
                                <dsp:option value="American Express"/>American Express
                            </dsp:select><br>
                            <b>Number:</b> <dsp:input bean="ExpressCheckoutFormHandler.paymentGroup.creditCardNumber"
                                                      maxsize="20" size="20" type="text" value="4111111111111111"
                                                      required="<%=true%>"/><br>
                            <b>Expiration Date:</b>
                            Month:
                            <dsp:select bean="ExpressCheckoutFormHandler.paymentGroup.expirationMonth">
                            ...
                            Year:
                            <dsp:select bean="ExpressCheckoutFormHandler.paymentGroup.expirationYear">
