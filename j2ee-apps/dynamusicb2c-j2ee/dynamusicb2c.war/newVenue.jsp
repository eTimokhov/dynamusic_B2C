                    ...
                    <dsp:form action="newVenue.jsp" method="post">
                        ...
                        <table cellpadding="10">
                            ...
                            <tr>
                                ...
                                <td>
                                    <font size="-2">Street</font> <dsp:input bean="VenueFormHandler.value.street1"
                                                                             size="24" type="text"/><br>
                                    <font size="-2">Street</font> <dsp:input bean="VenueFormHandler.value.street2"
                                                                             size="24" type="text"/><br>
                                    <font size="-2">City</font> <dsp:input bean="VenueFormHandler.value.city" size="10"
                                                                           type="text"/>
                                    <font size="-2">State</font> <dsp:input bean="VenueFormHandler.value.state" size="2"
                                                                            type="text"/>
                                    <font size="-2">Zip</font> <dsp:input bean="VenueFormHandler.value.zip" size="5"
                                                                          type="text"/>
                                </td>
                            </tr>
                            <tr>
