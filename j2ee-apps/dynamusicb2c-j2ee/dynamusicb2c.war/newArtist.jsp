                ...
                <font face="Verdana,Geneva,Arial" size="-1">
                    ...
                    <table cellpadding="10">
                        <tr>
                            ...
                            <td valign="middle">
                                <dsp:input bean="/dynamusic/ArtistFormHandler.value.name" name="name" size="24"
                        ...
                        <tr>
                            ...
                            <td valign="middle">
                                <dsp:input bean="/dynamusic/ArtistFormHandler.value.photoURL" name="photoURL" size="24"
                                           type="text"/><br>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <dsp:input bean="/dynamusic/ArtistFormHandler.create" type="Submit"
                                           value="Create Artist Entry"/>
                                <dsp:input bean="/dynamusic/ArtistFormHandler.createSuccessURL" type="hidden"
                                           value="artists.jsp"/>
                            </td>
                        </tr>
                        </dsp:form>
